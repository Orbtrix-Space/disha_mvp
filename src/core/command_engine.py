"""
Command Engine for DISHA MVP.
Converts task schedules into telecommand sequences.
Supports validation, logging, and operator approval workflow.
"""
...
# Telecommand templates for different task types
COMMAND_TEMPLATES = {
    "IMAGING": [
...
class CommandEngine:
    ...
    def generate_sequence(self, plan_details: list, plan_id: str = None) -> dict:
        """
        Convert a list of scheduled tasks into a telecommand sequence.
        """
        if plan_id is None:
